...
UKF::UKF() {
  ...
  // initilizing the initailized true variable to false
  ...
  // for a cycle that travels at max accel of 2m/s2 //
  std_a_ = 1;
  ...
  Hint: one or more values initialized above might be wildly off... check accel and yaw
  */
  ...
  //R - predidcted covariance - Matrix for Laser and Radar
  //defining these in the header file - ukf.h
    ...
    if (!is_initialized_){
        ...
        if (meas_package.sensor_type_ == MeasurementPackage::RADAR){
          ...
          x_ << meas_package.raw_measurements_[0],
                ...
                0, 0, 0;
          // use a smaller variance for lidar
          P_(0,0) = 0.5;
          P_(1,1) = 0.5;
        }
...
void UKF::Prediction(double delta_t) {
  ...
  */
    //create augmented mean state
      ...
      //create augmented sigma points as columns
      ...
      //predict sigma points as columns
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
  ...
  */
    int n_z = 2; //dim of measurement vector
     ...
     //NIS - consistency check of estimation
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
    int n_z = 3; //dim of measurement vector
      ...
      //NIS consistency check for radar
